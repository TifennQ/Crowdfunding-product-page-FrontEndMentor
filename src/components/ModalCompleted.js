...
const ModalCompleted = ({setIsModalCompletedOpen, isModalCompletedOpen}) => {
    return (
        <>
            {
            isModalCompletedOpen && (
                <section className="absolute w-11/12 bg-white py-8 px-5 z-40 mt-32 mx-4 border rounded-lg text-center modal">
